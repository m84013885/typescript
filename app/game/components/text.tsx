...
export const fetchRes = [
    ...
    },
    {
        "step": 4,
        "type": 11,
        "content": '经过两个星期给你的教训，你知道你要改变策略了，现在不在是只投心仪的公司，而是广撒网的投简历的策略，不管三七二十一，先去面试再说。',
        "level": 0,
    },
    {
        "step": 5,
        "type": 11,
        "content": '又过了一个星期，总算有一家公司联系了你，那家公司给了你两个时间，这个周末或者下周一。你看了看天气预报，说是这个周末是连续的大雨，而下周一是个大晴天。你的选择是。',
        "level": 1,
        "tabs": [
            {
                "to": 6,
